#!/usr/bin/env bash
# hydra/scripts/run-log.sh — per-run lifecycle summary (durable markdown audit record).
#
...
# and routes the 'run-log' subcommand to the TypeScript harness (HYDRA_HARNESS
